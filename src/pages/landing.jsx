...
export default function Landing() {
  /* VANTA Logic - Exactly as provided */
  useEffect(() => {
        ...
        <Container maxWidth="lg">
          <Toolbar sx={{ justifyContent: "space-between", py: 1 }}>
            ...
            <Stack direction="row" spacing={3} alignItems="center">
              <Typography variant="body2" sx={{ cursor: "pointer", color: "rgba(255,255,255,0.6)", '&:hover': { color: "#fff" }, display: { xs: 'none', sm: 'block' } }}>
                Join as Guest
              </Typography>
          ...
          <Box flex={1.2}>
            ...
            <Button
              ...
              sx={{
                ...
                "&:hover": { boxShadow: "0 15px 40px rgba(168, 85, 247, 0.4)", transform: "translateY(-3px)" },
                transition: "all 0.3s"
              }}
            >
              Get Started
          ...
          <Stack direction={{ xs: "column-reverse", md: "row" }} spacing={10} alignItems="center">
            ...
            <Box flex={1.2}>
              ...
              <Typography variant="h2" fontWeight={900} sx={{ 
                fontSize: { xs: "2.2rem", md: "3.2rem" }, mb: 3, mt: 1,
              ...
              <Typography sx={{ color: "rgba(255,255,255,0.6)", mb: 4, fontSize: "1.1rem", lineHeight: 1.8 }}>
                ...
                and real-time collaboration tools to keep your business moving forward.
              </Typography>
          ...
          <Stack direction={{ xs: "column", md: "row" }} spacing={10} alignItems="center">
            <Box flex={1.2}>
              ...
              <Typography variant="body1" sx={{ color: "rgba(255,255,255,0.6)", mb: 4, lineHeight: 1.8, fontSize: "1.1rem" }}>
                Whether you are on your desktop, laptop, or mobile—Convox Meet works 
                perfectly everywhere. Join instantly from your browser with a single 
                link, no bulky app downloads required.
              </Typography>
